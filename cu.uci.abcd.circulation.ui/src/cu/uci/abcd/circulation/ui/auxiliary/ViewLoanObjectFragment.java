...
public class ViewLoanObjectFragment extends FragmentPage {
	...
	public Control createUIControl(Composite parent) {
		...
		if (loanObjectDataCurrent.getAuthor() != null) {
		...
		// lbRecordTransaction.getText().toString();
		...
		// FormDatas.attach(tableHistorialTransaciones).atTopTo(lbRecordTransaction,
		// 3).atLeft(15).atRight(15);
		...
		TreeTableColumn columnsTransaccion[] = { new TreeTableColumn(16, 0, "getLoanObject.getTitle"), new TreeTableColumn(16, 1, "getLoanObject.getAuthor"), new TreeTableColumn(16, 2, "getLoanObject.getRecordType.getNomenclatorName"), new TreeTableColumn(15, 3, "getState.getNomenclatorName"),
				new TreeTableColumn(19, 4, "getLoanUser.fullName"), new TreeTableColumn(14, 5, "getLoanUser.getLoanUserType.getNomenclatorName") };
		...
		// final String userRecordReservations =
		// lbUserRecordReservations.getText().toString();
		...
		// final String recordSanctions =
		// lbUserRecordSanctions.getText().toString();
	...
	private void initializeGridReservationHistorico(LoanObject LoanObjectLoaded, int page, int size) {
		...
		// Page<Reservation> listReservationHistory =
		// ((AllManagementLoanUserViewController)
		// controller).findAllReservationSearchLoanObject(idLoanObject, page,
		// size, direction, orderByStringReservations);
