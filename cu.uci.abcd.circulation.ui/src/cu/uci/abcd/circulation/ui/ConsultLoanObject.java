...
/**
 * RF_CI15 Asociar Objeto de Préstamo
 * RF_CI15.1 Buscar Objetos de Préstamo por criterios
 * RF_CI15.2 Listar Objetos de Préstamo coincidentes
 * RF_CI15.2.2 Mostrar cantidad de Objetos de Préstamo coincidentes encontrados en la búsqueda
 * RF_CI15.3 Asociar Objetos de Préstamos listados
 * @author alberto
 *
 */
