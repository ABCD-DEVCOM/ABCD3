...
/**
 * RF_OP8.1.3 Registrar comentarios a un material, RF_OP8.1.4 Visualizar
 * comentarios de un material, RF_OP8.1.5 Editar Comentario, RF_OP8.1.6 Eliminar
 * Comentario, RF_OP8 Visualizar los detalles de un resultado de búsqueda,
 * RF_OP8.1 Visualizar los detalles de un resultado de búsqueda en una Vista
 * MARC, RF_OP8.1.1 Visualizar los detalles de un resultado de búsqueda en una
 * Vista ISBD, RF_OP8.1.7 Agregar etiquetas a un registro bibliográfico,
 * RF_OP8.1.8 Visualizar etiquetas, RF_OP8.1.9 Eliminar etiquetas, RF_OP8.1.2
 * Descargar Material
 * 
 * @author dailien
 * 
...
public class ViewLog extends ContributorPage {
	...
	public Control createUIControl(Composite parent) {
		...
		FormDatas.attach(compoDescription).atTopTo(tabFolder, 5).atLeft(0).atRight(0).withHeight(500);
		...
		try {
			...
			descriptionContent.setFont(new Font(parent.getDisplay(), "Arial", 12, SWT.NORMAL));		
			
			FormDatas.attach(descriptionContent).atTop(20).atLeft(20).atRight(20).withHeight(description.length() / 5);
